        ...
        <div className="ml-[29%] mt-20 text-[#100E0E]">
          ...
          <div className="mt-[-25%] ml-[100%]">
            <svg xmlns="http://www.w3.org/2000/svg" width="16.482" height="19.434" viewBox="0 0 20 17" fill="none">
              <rect x="0.138977" y="9.04883" width="1.15946" height="19.2297" transform="rotate(-90 0.138977 9.04883)" fill={!myState ? "#131313" : "white"} />
              <rect x="12.3485" y="1.01855" width="1.15946" height="9.75225" transform="rotate(-38.8464 12.3485 1.01855)" fill={!myState ? "#131313" : "white"} />
              <rect width="1.15946" height="9.75225" transform="matrix(0.77883 0.627235 0.627235 -0.77883 12.3484 15.9147)" fill={!myState ? "#131313" : "white"} />
            </svg>
          </div>
          <div className="mt-[-60%] ml-[58%]">
            {!myState ? <svg xmlns="http://www.w3.org/2000/svg" width="90" height="89" viewBox="0 0 90 89" fill="none">
              <circle cx="44.8558" cy="44.4689" r="43.6546" transform="rotate(-90 44.8558 44.4689)" stroke={!myState ? "#131313" : "white"} stroke-width="1" />
            </svg> : <svg xmlns="http://www.w3.org/2000/svg" width="89" height="89" viewBox="0 0 89 89" fill="none">
              <g opacity="0.6">
                <g filter="url(#filter0_i_332_230)">
                  <circle cx="44.2176" cy="44.7814" r="44.1546" transform="rotate(-90 44.2176 44.7814)" fill="url(#paint0_radial_332_230)" />
                </g>
                <circle cx="44.2176" cy="44.7814" r="43.6546" transform="rotate(-90 44.2176 44.7814)" stroke="white" />
              </g>
              <defs>
                <filter id="filter0_i_332_230" x="-2.93701" y="0.626831" width="91.3092" height="88.3092" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                  ...
                  <feBlend mode="normal" in2="shape" result="effect1_innerShadow_332_230" />
                </filter>
                <radialGradient id="paint0_radial_332_230" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(46.7279 65.6261) rotate(-86.88) scale(92.6688 121.391)">
