...
const Navbar = () => {
  ...
  if (isMenuOpen) {
    gsap.to(menu, { x:"-100%", opacity: 1, duration: 1, yoyo:true, ease: "power3.inOut" });
    ...
    tl.to(lines[0], {
      ...
      .to(
        lines[1],
        { duration: 1, rotate: "90deg", y: -15, x: 0, ease: "power2.out" },
        "-=1"
      )
      ...
      .to(
        lines[3],
        { duration: 1, scaleY: 0, transformOrigin: "top", ease: "power2.out" },
        "-=1"
      );
  } else {
    ...
    <nav className="">
      <div className="container ml-[3.5%]">
        <div className="flex items-center justify-between  ">
          ...
          <div className=" flex items-center z-50 space-x-4 fixed right-12  text-[#100E0E]">
            <ul
              className={`menu-ul flex md:mr-56 lg:mr-4 ${
                isMenuOpen ? "visible" : "visible"
              } space-x-4 mt-10`}
            >
            ...
            <button
              className="text-black focus:outline-none mt-16 md:mt-16 lg:mt-16 right-[-44%] "
              onClick={toggleMenu}
            >
      ...
      <div className="lg:hidden md:hidden">
        {isMenuOpen && (
          <div className=" w-screen  border fixed z-[999] h-[100vh] bg-black bg-opacity-100  flex items-center justify-center">
            <nav>
              <button
                className="text-black focus:outline-none  ml-44"
                onClick={toggleMenu}
              >
